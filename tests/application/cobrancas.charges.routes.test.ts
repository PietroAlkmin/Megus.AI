...
async function seedCenario() {
  ...
  const chargePendente: Charge = {
    ...
    calendarEventId: null, chargedAt: null, paidAt: null, scheduledFor: null, paymentRef: null, paidBy: null, receiptHash: null, notaSolicitada: null, notaEmitidaEm: null, createdAt: now, updatedAt: now,
  };
  const chargeCobrada: Charge = {
    ...
    calendarEventId: null, chargedAt: now, paidAt: null, scheduledFor: null, paymentRef: null, paidBy: null, receiptHash: null, notaSolicitada: null, notaEmitidaEm: null, createdAt: now, updatedAt: now,
  };
  const chargePaga: Charge = {
    ...
    calendarEventId: null, chargedAt: now, paidAt: now, scheduledFor: null, paymentRef: null, paidBy: null, receiptHash: null, notaSolicitada: null, notaEmitidaEm: null, createdAt: now, updatedAt: now,
  };
